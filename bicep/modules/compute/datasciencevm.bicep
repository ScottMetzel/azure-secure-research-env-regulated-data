...
resource dsVmNics 'Microsoft.Network/networkInterfaces@2023-05-01' = [for i in range(0, vmCount): {
...
resource dsVms 'Microsoft.Compute/virtualMachines@2023-07-01' = [for i in range(0, vmCount): {
...
resource aadLoginExtensions 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = [for i in range(0, vmCount): {
...
resource amaExtensions 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = [for i in range(0, vmCount): {
